...
namespace api_recomendation.Migrations
{
    ...
    [Migration("20230508170745_CreateTableAttrEntityProfile")]
    partial class CreateTableAttrEntityProfile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api_recomendation.Models.Auth.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Action = "create",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "create AttributeEntityProfile",
                            Model = "AttributeEntityProfile",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Action = "read",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "read AttributeEntityProfile",
                            Model = "AttributeEntityProfile",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Action = "update",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "update AttributeEntityProfile",
                            Model = "AttributeEntityProfile",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Action = "delete",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "delete AttributeEntityProfile",
                            Model = "AttributeEntityProfile",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        ...
                        new
                        {
                            ...
                            Action = "read",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "read Recommendation",
                            Model = "Recommendation",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
            ...
            modelBuilder.Entity("api_recomendation.Models.Auth.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 5, 8, 12, 7, 44, 679, DateTimeKind.Local).AddTicks(5460),
                            Description = "admin",
                            Name = "admin",
                            UpdatedAt = new DateTime(2023, 5, 8, 12, 7, 44, 679, DateTimeKind.Local).AddTicks(5471)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 5, 8, 12, 7, 44, 679, DateTimeKind.Local).AddTicks(5475),
                            Description = "user",
                            Name = "user",
                            UpdatedAt = new DateTime(2023, 5, 8, 12, 7, 44, 679, DateTimeKind.Local).AddTicks(5476)
                        });
                });
