...
namespace api_recomendation.Migrations
{
    ...
    [Migration("20230509143436_AlterTableEntity")]
    partial class AlterTableEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api_recomendation.Models.Auth.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 5, 9, 9, 34, 36, 180, DateTimeKind.Local).AddTicks(7796),
                            Description = "admin",
                            Name = "admin",
                            UpdatedAt = new DateTime(2023, 5, 9, 9, 34, 36, 180, DateTimeKind.Local).AddTicks(7807)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 5, 9, 9, 34, 36, 180, DateTimeKind.Local).AddTicks(7810),
                            Description = "user",
                            Name = "user",
                            UpdatedAt = new DateTime(2023, 5, 9, 9, 34, 36, 180, DateTimeKind.Local).AddTicks(7811)
                        });
                });
