...
public class EntityService : IEntityService
{
    ...
    public Entity GetByIndentifier(string indentifier)
    {
        return _context.Entities.FirstOrDefault(x => x.Identifier == indentifier);
    }
...
public interface IEntityService
{
    ...
    Entity GetByIndentifier(string indentifier);
